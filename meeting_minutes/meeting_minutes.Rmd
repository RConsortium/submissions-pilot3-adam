...
## Pilot 3 Package Readme
- [Thanks, Steven](https://github.com/RConsortium/submissions-pilot3-utilities/tree/readme)

## Tasks and Assignments
- Check R-CMD-check [Thanks, Ben](https://github.com/RConsortium/submissions-pilot3-adam/pull/110)
- Investigate rtf conversion for report-tlf.pdf [Assigned to Phani](https://merck.github.io/r2rtf/articles/rtf-convert-format.html)
- Testing from the FDA package [Assigned to Phani, Robert, Nicole](https://github.com/RConsortium/submissions-pilot3-adam-to-fda/issues/12)
- Update ADRG guide and appendix [Assigned to Robert, Steven](https://github.com/RConsortium/submissions-pilot3-adam-to-fda/issues/13)
- Cover letter update [Assigned to Lei](https://github.com/RConsortium/submissions-pilot3-adam-to-fda/issues/1)
- Website update [Thanks, Ben](https://phuse.s3.eu-central-1.amazonaws.com/Archive/2023/SDE/EU/London/PRE_London09.pdf)
- QUARTO website [Assigned to Phani, Robert](https://quarto.org/docs/publishing/github-pages.html)
...
- **FDA Repo Updates:**
  ...
  - Robert assigned to issue #59 to update report-tlf.pdf; Phani to connect with Robert for support.
  - Declan to update readme in FDA repo [here](https://github.com/RConsortium/submissions-pilot3-adam-to-fda/issues/10); Phani/Lei to review.
...
### Robert:
- Updated the site [https://rconsortium.github.io/submissions-pilot3-adam/main/](https://rconsortium.github.io/submissions-pilot3-adam/main/)
...
- Provided materials for discussion:
    ...
    2. [Pilot3 report-adam.pdf](2) (based on updated Pilot3 QC Findings with finalized ADRG)
    3. Pilot3 Website (GH Pages feature) for discussion (limitations, differences from Pilot1, and related)

---

### Kaz:
- Discussed the Pinnacle 21 report for SDTM.
- Proposed creating a submissions folder called 'sdtm' [here](https://github.com/RConsortium/submissions-pilot3-adam/tree/main/submission).
...
### Ben:
- Will collaborate with Joel to understand the cleanup of the project area vs package area for Pilot 3.

---

[1]: Pilot3 report-tlf.pdf
[2]: Pilot3 report-adam.pdf
...
-   Meeting Recorded: Yes : https://drive.google.com/file/d/1ApLsg52brtVxt6UuAxcu3rzFpCDk8Y0j/view?usp=sharing
