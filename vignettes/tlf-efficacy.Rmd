...
The Pilot 1 Team generated the below output using R and it was delivered to the FDA. You can find the source code that generated this output [here](https://github.com/RConsortium/submissions-pilot1/blob/main/vignettes/tlf-efficacy.Rmd) and a deeper dive of the process [here](https://rconsortium.github.io/submissions-pilot1/articles/tlf-efficacy.html).  We delivered the identical output with the R generated ADaM.
