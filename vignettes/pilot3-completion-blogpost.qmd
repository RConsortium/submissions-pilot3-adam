...
The R Consortium is pleased to announce that on Aug 8, 2024, the R Submissions Working Group successfully completed the follow-up test submission for Pilot 3 and received the FDA CDER response letter! 

The full response letter can be found at: [FDA response letter](https://github.com/RConsortium/submissions-wg/blob/main/_Documents/Summary_R_Pilot3_Submission.pdf)  
...
This is the first publicly available R-based FDA submission package including R scripts to generate Analysis Data Models (ADaM) and Tables, Listings & Figures (TLFs).

**Pilot 3 Scope**

The Pilot 3 test submission is an example of an all R submission package for ADaMs and TLFs following electronic Common Technical Document (eCTD) specifications. This R Submission package included the installation and loading of the proprietary {pilot3utils} R package and other open-source R packages, R scripts for the analysis data model (ADaM) datasets from Pilot 3 and tables, listings, figures (TLFs) from Pilot 1, the Analysis Data Reviewer's Guide (ADRG), and other required eCTD components. 
